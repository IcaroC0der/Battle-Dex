      ...
      <div className="w-full max-w-md">
        ...
        <div className="gb-box p-8 w-full text-center">
          <div className="flex flex-col items-center mb-8">
            <h1 className="text-4xl font-bold text-slate-900 uppercase">Cadastro</h1>
            <p className="text-slate-700 font-bold text-lg mt-1">Crie sua conta para começar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            ...
            <div className="space-y-2">
              <label className="text-xl font-bold text-slate-900 uppercase" htmlFor="name">Nome de Treinador</label>
              <input
                id="name"
                type="text"
                required
          ...
          <p className="mt-8 text-center text-lg font-bold text-slate-700">
            Já tem uma conta?{" "}
            <Link href="/login" className="text-blue-600 hover:text-blue-800 uppercase transition-all-smooth">
              Faça login
            </Link>
          </p>
        </div>
